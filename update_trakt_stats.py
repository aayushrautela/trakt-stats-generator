...
def generate_trakt_svg(trakt_username, access_token):
    ...
    try:
        ...
        if not history:
            ...
            <div style="background-color: #151515; border-radius: 6px; padding: 16px; border: 1px solid #ffffff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji'; color: #fff; display: flex; align-items: center; height: {svg_height - 34}px;">
